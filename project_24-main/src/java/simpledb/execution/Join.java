...
public class Join extends Operator {
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        // some code goes here
        while (this.currentLeftTuple != null || this.child1.hasNext()) {
            Tuple leftTuple;
            if (this.currentLeftTuple != null) {
                leftTuple = this.currentLeftTuple;
            } else {
                this.currentLeftTuple = this.child1.next();
                leftTuple = this.currentLeftTuple;
            }
            while (this.child2.hasNext()) {
                Tuple rightTuple = this.child2.next();
                if (this.p.filter(leftTuple, rightTuple)) {
                    return this.joinTuples(leftTuple, rightTuple);
                }
            }
            this.currentLeftTuple = null;
            this.child2.rewind();
